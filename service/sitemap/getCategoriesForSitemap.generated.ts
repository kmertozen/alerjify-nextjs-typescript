...
export type GetCategoriesForSitemapQueryVariables = Types.Exact<{ [key: string]: never; }>;
...
export const GetCategoriesForSitemapDocument = `
  ...
  categories {
    ...
    `;
export const useGetCategoriesForSitemapQuery = <
      TData = GetCategoriesForSitemapQuery,
      TError = unknown
    >(
      dataSource: { endpoint: string, fetchParams?: RequestInit },
      variables?: GetCategoriesForSitemapQueryVariables,
      options?: UseQueryOptions<GetCategoriesForSitemapQuery, TError, TData>
    ) =>
    useQuery<GetCategoriesForSitemapQuery, TError, TData>(
      variables === undefined ? ['getCategoriesForSitemap'] : ['getCategoriesForSitemap', variables],
      fetcher<GetCategoriesForSitemapQuery, GetCategoriesForSitemapQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, GetCategoriesForSitemapDocument, variables),
      options
    );