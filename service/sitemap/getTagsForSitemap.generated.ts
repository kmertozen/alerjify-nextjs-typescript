...
export type GetTagsForSitemapQueryVariables = Types.Exact<{ [key: string]: never; }>;
...
export const GetTagsForSitemapDocument = `
    query getTagsForSitemap {
  tags {
    data {
      attributes {
        slug
    ...
    `;
export const useGetTagsForSitemapQuery = <
      TData = GetTagsForSitemapQuery,
      TError = unknown
    >(
      dataSource: { endpoint: string, fetchParams?: RequestInit },
      variables?: GetTagsForSitemapQueryVariables,
      options?: UseQueryOptions<GetTagsForSitemapQuery, TError, TData>
    ) =>
    useQuery<GetTagsForSitemapQuery, TError, TData>(
      variables === undefined ? ['getTagsForSitemap'] : ['getTagsForSitemap', variables],
      fetcher<GetTagsForSitemapQuery, GetTagsForSitemapQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, GetTagsForSitemapDocument, variables),
      options
    );