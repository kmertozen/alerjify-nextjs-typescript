...
export type GetHomepageSlidersQueryVariables = Types.Exact<{ [key: string]: never; }>;
...
export const GetHomepageSlidersDocument = `
  ...
  homepage {
    ...
    `;
export const useGetHomepageSlidersQuery = <
      TData = GetHomepageSlidersQuery,
      TError = unknown
    >(
      dataSource: { endpoint: string, fetchParams?: RequestInit },
      variables?: GetHomepageSlidersQueryVariables,
      options?: UseQueryOptions<GetHomepageSlidersQuery, TError, TData>
    ) =>
    useQuery<GetHomepageSlidersQuery, TError, TData>(
      variables === undefined ? ['getHomepageSliders'] : ['getHomepageSliders', variables],
      fetcher<GetHomepageSlidersQuery, GetHomepageSlidersQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, GetHomepageSlidersDocument, variables),
      options
    );